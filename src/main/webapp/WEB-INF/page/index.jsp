                ...
                <dl class="pic_list">
                    ...
                    <dd>
                        <div class="pic_list_box">
                            ...
                            <p class="pinggu"><a href="goods/info/${phones.id}" title="在线评估iphone 7回收价格"><!----></a>
                            </p>
...
<script type="text/javascript">
    var vue =  new Vue({
        ...
        data() {
            return{
                brandURL: "http://localhost:8081/goods/queryBrandById/",
                typeList: null,
                brandList: null,
                /*ck:true*/
            }
        ...
        methods:{
            ...
            axios.get("http://localhost:8081/goods/queryTbTypeList")
                .then(response => (this.typeList = response.data.obj));
            axios.get("http://localhost:8081/goods/queryBrandById/1")
